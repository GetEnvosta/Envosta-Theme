 ...
 *
 * On WXR import, read the _envosta_* post-meta that Studio embeds on the
 * Home page, apply the values to site options (title, tagline, static
 * homepage, posts page, nav menu location, style variation), then clean
 * up the meta so the hook is a no-op on subsequent imports.
 */
