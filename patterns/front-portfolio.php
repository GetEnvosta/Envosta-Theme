		...
		<div class="wp-block-column is-vertically-aligned-center envosta-reveal" style="flex-basis:52%">
			...
			<div class="wp-block-columns">
				...
				<div class="wp-block-column">
					...
					<!-- wp:group {"className":"envosta-card-hover","style":{"dimensions":{"aspectRatio":"4/5"},"border":{"radius":"14px"},"color":{"background":"<?php echo esc_attr( $project['grad'] ); ?>"},"spacing":{"padding":{"top":"1.25rem","right":"1.25rem","bottom":"1.25rem","left":"1.25rem"}}},"layout":{"type":"flex","orientation":"vertical","justifyContent":"space-between"}} -->
					<div class="wp-block-group envosta-card-hover has-background" style="border-radius:14px;background:<?php echo esc_attr( $project['grad'] ); ?>;aspect-ratio:4/5;padding:1.25rem"><!-- wp:paragraph {"style":{"typography":{"fontSize":"0.75rem","fontWeight":"600","letterSpacing":"0.08em","textTransform":"uppercase"},"color":{"text":"#0f172a"}}} --><p class="has-text-color" style="color:#0f172a;font-size:0.75rem;font-weight:600;letter-spacing:0.08em;text-transform:uppercase"><?php echo esc_html( $project['year'] ); ?></p><!-- /wp:paragraph --><!-- wp:paragraph {"style":{"typography":{"fontSize":"1rem","fontWeight":"600","letterSpacing":"-0.01em"},"color":{"text":"#0f172a"}}} --><p class="has-text-color" style="color:#0f172a;font-size:1rem;font-weight:600;letter-spacing:-0.01em"><?php echo esc_html( $project['label'] ); ?></p><!-- /wp:paragraph --></div>
					<!-- /wp:group -->
					<?php endforeach; ?>
				</div>
				<!-- /wp:column -->
