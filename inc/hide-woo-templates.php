...
/* Note: an earlier version of this file stripped WC's custom
 * 'mini-cart' and 'add-to-cart-with-options' template-part areas to
 * tidy the Site Editor sidebar. That broke the woocommerce/mini-cart
 * block on the frontend (the block validates its area against the
 * registered list and renders empty when the area is missing).
 * The cleanup isn't worth that cost — the buckets stay. */
